...
int main(int argc, char* argv[]) {
...

    {
        ...
        if (current_m > 1 && can_use_chunk64_0()) {
            ...
            const size_t ls0 = 64;
            add_planned_kernel(iter_plan, use_small31_entry_refresh ? "forward64_0_small31_refresh" : "forward64_0", gs0, ls0, [&](cl_kernel k) {
        ...
        for (size_t back_m = (current_m == 1) ? 4 : 2, back_s = s / 4; back_s >= 1; back_m *= 4, back_s /= 4) {
            ...
            if (back_s == 64 && can_use_chunk64_0()) {
                const size_t gs = h / 4;
                const size_t ls = 64;
                add_planned_kernel(iter_plan, use_small31_entry_refresh ? "backward64_0_small31_defer" : "backward64_0", gs, ls, [&](cl_kernel k) {
